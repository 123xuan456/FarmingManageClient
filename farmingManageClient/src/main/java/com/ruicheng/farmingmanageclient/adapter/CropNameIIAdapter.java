...
import com.ruicheng.farmingmanageclient.adapter.CropPtypeNameAdapter.ViewHolder;
...
public class CropNameIIAdapter extends BaseAdapter {
	private List<Object> listAll ;
	private Context context ;
	public CropNameIIAdapter(List<Object> listAll,Context context){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHolder.tv_dc.setText(stationInfo.getCropTypes());
		return convertView;
	}
