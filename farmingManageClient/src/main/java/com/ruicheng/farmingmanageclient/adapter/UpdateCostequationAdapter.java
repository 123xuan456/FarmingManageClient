 ...
 *
 */
public class UpdateCostequationAdapter extends BaseAdapter {
	private List<CustomCostListInfo> listAll ;
	private Context context ;
	private List<ChargeListInfo> chargeListInfoList ;
	public UpdateCostequationAdapter(List<CustomCostListInfo> listAll,Context context,List<ChargeListInfo> chargeListInfoList){
