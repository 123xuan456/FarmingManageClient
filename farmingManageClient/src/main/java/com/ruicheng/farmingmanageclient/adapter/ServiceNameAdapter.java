...
public class ServiceNameAdapter extends BaseAdapter {
	...
	public ServiceNameAdapter(List<Object> listAll,Context context){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		StationData stationData = (StationData) listAll.get(position);
		
		viewHolder.tv_servicename.setText(stationData.getStationName());
