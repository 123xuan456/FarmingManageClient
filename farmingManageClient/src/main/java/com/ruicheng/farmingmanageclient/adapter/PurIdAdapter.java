...
public class PurIdAdapter extends BaseAdapter {
	private List<Object> listAll ;
	private Context context ;
	public PurIdAdapter(List<Object> listAll,Context context){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		PurchaseOrderInfo stationInfo= (PurchaseOrderInfo) listAll.get(position);
		viewHolder.tv_dc.setText(stationInfo.getPrintCode());
		return convertView;
	}
